...
export const metadata: Metadata = {
  title: "회사소개 | 경기살수 – 살수차·급수차 전문",
  description: "경기살수 회사소개. 창업 이력, 보유 장비, 인증·면허 현황.",
};
      ...
      <section className="bg-brand-bg py-14 border-b border-brand-light">
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <p className="text-brand-gray">
            수도권·경기 지역 살수차·급수차 전문 업체, 경기살수를 소개합니다.
          </p>
        </div>
      </section>
      ...
      <section className="py-14">
        <div className="max-w-3xl mx-auto px-4">
          ...
          <div className="card mt-4">
            ...
            <br />
            <p className="text-gray-700 leading-relaxed">
              저희 경기살수는 수도권·경기 지역을 기반으로 <strong>살수차·급수차 전문 서비스</strong>를 제공하고 있습니다.
